...
class _RoundCheckBoxState extends State<RoundCheckBox> {
  ...
  void didUpdateWidget(RoundCheckBox oldWidget) {
    ...
    if (checkedWidget != widget.checkedWidget) {
      checkedWidget = widget.checkedWidget ?? Icon(Icons.check, color: Colors.white, size: (size ?? 0.0) * 0.7);
    }
            ...
            child: ClipRRect(
              ...
              child: AnimatedContainer(
                ...
                decoration: BoxDecoration(
                  color: isChecked! ? checkedColor ?? Theme.of(context).primaryColor : uncheckedColor,
